			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="footer-widget footer-menu">
						...
						<ul>
							<li><a href=""><i class="fas fa-angle-double-right"></i> Search</a></li>
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="footer-widget footer-menu">
						...
						<ul>
							<li><a href=""><i class="fas fa-angle-double-right"></i> Show</a></li>
				...
				<div class="row">
					<div class="col-md-6 col-lg-6">
						<div class="copyright-text">
							<p class="mb-0">&copy; 2022 Test. All rights reserved.</p>
						</div>
					</div>
					<div class="col-md-6 col-lg-6">
